...
public class ItemFrontRotationTool extends Item {
    ...
    public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List aList, boolean p_77624_4_) {
        ...
        aList.add(EnumChatFormatting.BLUE
                + translateToLocal("item.structurelib.frontRotationTool.desc.1")); // Rotates only the front panel,
        aList.add(EnumChatFormatting.BLUE
                + translateToLocal("item.structurelib.frontRotationTool.desc.2")); // which allows structure rotation.
    }
}
