package com.gtnewhorizon.structurelib.mixins;
...
import com.gtnewhorizon.structurelib.core.StructureLibCore;
...
public enum Mixins {
    ...
    public static List<String> getEarlyMixins(Set<String> loadedCoreMods) {
        ...
        StructureLibCore.log.info("Not loading the following EARLY mixins: {}", notLoading.toString());
        return mixins;
    }
    ...
    public static List<String> getLateMixins(Set<String> loadedMods) {
        ...
        StructureLibCore.log.info("Not loading the following LATE mixins: {}", notLoading.toString());
        return mixins;
    }
